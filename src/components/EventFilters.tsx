...
export function EventFilters({ 
  ...
  return (
    <div className="w-full mb-8">
      {/* Main Search Section */}
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950/20 dark:to-blue-950/20 rounded-2xl p-6 lg:p-8 mb-8 shadow-sm border border-purple-100 dark:border-purple-800/30">
        <div className="flex flex-col gap-6">
          ...
          <div className="relative max-w-2xl mx-auto w-full">
            ...
            <input
              ...
              className="w-full pl-10 sm:pl-12 pr-6 py-3 sm:py-4 text-base sm:text-lg bg-white dark:bg-gray-900 border-2 border-purple-200 dark:border-purple-700 rounded-xl text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 focus:outline-none transition-all duration-200 shadow-sm"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 lg:gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="px-4 sm:px-6 py-2.5 sm:py-3 border-2 border-purple-200 dark:border-purple-700 rounded-xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 hover:border-purple-300 dark:hover:border-purple-600 focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 focus:outline-none appearance-none pr-10 sm:pr-12 min-w-[140px] sm:min-w-[180px] font-medium transition-all duration-200 shadow-sm text-sm sm:text-base"
              >
            ...
            <div className="relative">
              <select
                ...
                className="px-4 sm:px-6 py-2.5 sm:py-3 border-2 border-purple-200 dark:border-purple-700 rounded-xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 hover:border-purple-300 dark:hover:border-purple-600 focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 focus:outline-none appearance-none pr-10 sm:pr-12 min-w-[120px] sm:min-w-[160px] font-medium transition-all duration-200 shadow-sm text-sm sm:text-base"
              >
            ...
            {/* Date Range */}
            <div className="flex items-center gap-2 lg:gap-3 bg-white dark:bg-gray-900 border-2 border-purple-200 dark:border-purple-700 rounded-xl px-2 sm:px-3 lg:px-4 py-2.5 sm:py-3 shadow-sm">
              <CalendarDays className="h-5 w-5 text-purple-400 flex-shrink-0" />
              <input
                type="date"
                value={selectedDateRange.start}
                onChange={(e) => setSelectedDateRange({...selectedDateRange, start: e.target.value})}
                className="border-0 bg-transparent text-gray-900 dark:text-gray-100 focus:outline-none font-medium w-[100px] sm:w-[110px] lg:w-auto text-sm sm:text-base"
              />
              <span className="text-purple-400 font-medium text-sm lg:text-base">to</span>
              <input
                type="date"
            ...
            <button 
              ...
              className={`flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2.5 sm:py-3 border-2 rounded-xl font-medium transition-all duration-200 shadow-sm text-sm sm:text-base ${
                showAdvancedFilters 
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl p-4 sm:p-5 lg:p-6 shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Discover Events</h2>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Find stepping events, workshops, and community gatherings</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 lg:gap-6 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-2 lg:gap-3 w-full sm:w-auto">
              ...
              <select 
                ...
                className="border-2 border-gray-200 dark:border-gray-700 rounded-lg px-3 lg:px-4 py-2 text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 hover:border-gray-300 dark:hover:border-gray-600 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 focus:outline-none transition-all duration-200 flex-1 sm:flex-initial"
              >
