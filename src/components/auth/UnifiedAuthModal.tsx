...
export const UnifiedAuthModal = ({ 
  ...
  const [internalIsOpen, setInternalIsOpen] = useState(mode === 'page' ? true : false)
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // Modal will close or redirect when auth context updates
      }
    } catch (err) {
  ...
  if (mode === 'page') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 flex items-center justify-center p-4">
        <div className="w-full max-w-md border-border bg-card shadow-xl rounded-lg">
          ...
          <div className="px-6 pb-6 space-y-4">
            ...
            {/* All the auth content - copy from modal version */}
