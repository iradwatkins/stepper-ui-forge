    ...
    <nav className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="container mx-auto px-4 h-14 sm:h-16">
        ...
        <div className="md:hidden flex items-center justify-between h-full relative">
          ...
          {/* Center: Logo */}
          <Link to="/" className="absolute left-1/2 transform -translate-x-1/2 flex items-center h-full">
            <img 
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            >
              ...
              {totalItems > 0 && (
                <Badge 
                  variant="destructive" 
                  className="absolute -top-2 -right-1 min-h-[18px] min-w-[18px] h-[18px] px-1 flex items-center justify-center text-[10px] font-medium"
                >
