-- CRITICAL REGISTRATION FIX: Resolves "Database error saving new user" issues
-- This script consolidates all necessary fixes for user registration problems
-- 
-- PROBLEMS FIXED:
...
-- STEP 7: Set up the designated admin user if they don't already have admin privileges
UPDATE profiles 
